...
define config.name = _("Petualangan Si Tika")
...
define config.version = "Ren'py 7.4"


## Text that is placed on the game's about screen. Place the text between the
## triple-quotes, and leave a blank line between paragraphs.

define gui.about = _(""" ^ Written : Anam 
instagram.com/anamkun46
Music by Bensound www.bensound.com
Storyline by Andy Rachman
""")
...
define config.main_menu_music = "audio/zero-project - The mafia.mp3"
...
define config.save_directory = "musik-1628874637"
