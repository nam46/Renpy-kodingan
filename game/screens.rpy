...
style button:
    properties gui.button_properties("button") hover_sound "music/hover.wav" activate_sound "music/alert.wav" 

style button_text is gui_text:
    properties gui.text_properties("button") hover_sound "music/hover.wav" activate_sound "music/click.wav"
    yalign 0.5
